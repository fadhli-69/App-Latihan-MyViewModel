...
class MainActivity : AppCompatActivity() {
    ...
    private val viewModel: MainViewModel by viewModels()  // Menggunakan delegation by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        displayResult()  // Menampilkan hasil awal jika ada
        ...
        activityMainBinding.btnCalculate.setOnClickListener {
            ...
            when {
                ...
                length.isEmpty() -> {
                    ...
                    // Panggil ViewModel untuk menghitung volume
                    viewModel.calculate(width, height, length)
                    displayResult()  // Tampilkan hasil setelah perhitungan
                }
            }
        }
    }
    ...
    private fun displayResult() {
        // Menampilkan hasil yang sudah dihitung oleh ViewModel
